...
<![endif]-->
		<script src='$pageConfig->js_mobile'></script>
		...
		<![endif]-->
		<script src='$pageConfig->jquery_dataTables_min'></script>
		<script src='$pageConfig->jquery_dataTables_bootstrap_min'></script>
		<script src='$pageConfig->dataTables_buttons_min'></script>
		<script src='$pageConfig->buttons_flash_min'></script>
		<script src='$pageConfig->buttons_html5_min'></script>
		<script src='$pageConfig->buttons_print_min'></script>
		<script src='$pageConfig->button_colVis_min'></script>
		<script src='$pageConfig->dataTable_select_min'></script>
