...
$page="
    <!DOCTYPE html>
        ...
        <![endif]-->
                ...
                <![endif]-->
                <script src='$pageData->jquery_dataTables_min'></script>
                <script src='$pageData->jquery_dataTables_bootstrap_min'></script>
                <script src='$pageData->dataTables_buttons_min'></script>
                <script src='$pageData->buttons_flash_min'></script>
                <script src='$pageData->buttons_html5_min'></script>
                <script src='$pageData->buttons_print_min'></script>
                <script src='$pageData->button_colVis_min'></script>
                <script src='$pageData->dataTable_select_min'></script>
        ...
        <script src='$pageData->js_form_table'></script>
            </body>
        </html>";
echo $page;
