                        ...
                        <div id='login-box' class='login-box visible widget-box no-border'>
                            <div class='widget-body'>
                                <div class='widget-main'>
                                    ...
                                    <form action='module/login.php' method='get' enctype='application/x-www-form-urlencoded'>
                                        <fieldset>
                        ...
                        <div id='forgot-box' class='forgot-box widget-box no-border'>
                            <div class='widget-body'>
                                <div class='widget-main'>
                                    ...
                                    <form action='module/retrieve_pwd.php' method='get' enctype='application/x-www-form-urlencoded'>
                                        <fieldset>
                                            <label class='block clearfix'>
														<span class='block input-icon input-icon-right'>
                        ...
                        <div id='signup-box' class='signup-box widget-box no-border'>
                            <div class='widget-body'>
                                <div class='widget-main'>
                                    ...
                                    <form action='module/register.php' method='get' enctype='application/x-www-form-urlencoded'>
                                        <fieldset>
                                             <label class='block clearfix'>
														<span class='block input-icon input-icon-right'>
